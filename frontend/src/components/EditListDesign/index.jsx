...
function EditListDesign({listDesign, setListDesign, idqrcode, setDialogOpen}) {
  ...
  return <div>
   <h3 style={{marginTop:0,marginRight: 20,marginLeft: 20}}>Liste des designs pour ce QR Code</h3>
   <IconButton
      aria-label="close"
